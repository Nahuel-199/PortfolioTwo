...
import quizz from "../../assets/projects/quizzapp.jpg";
import programminGame from "../../assets/projects/img_pr.png";
...
const Menu = [
    ...
    {
        id: 3,
        images: programminGame,
        title: "Programming Game",
        description: "Introducción a HTML, juego de preguntas y respuestas, explicación de lo que es HTML, para que se utiliza, que se puede hacer y ejemplos de caso de usos cotidianos.",
        link: "https://programming-game.vercel.app/"
    },
    {
        id: 4,
        images: quizz,
        title: "Trivia_App",
        description: "Juego de preguntas y respuestas, realizado con Reactjs y Javascrip, jugando con los setTimeout de javascript y los deley se logro un hermoso juego para pasar el rato",
        link: "https://trivia-app-beta-ochre.vercel.app/"
    },
    {
        id: 5,
        images: pr8,
